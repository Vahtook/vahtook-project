  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2 text-sm">
        <li><a href="#" className="hover:text-[#ff9d00] transition">Home</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">Services</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">About Us</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">Contact</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2 text-sm">
        <li><a href="#" className="hover:text-[#ff9d00] transition">Careers</a></li>
        
        
        <li><a href="#" className="hover:text-[#ff9d00] transition">Partners</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2 text-sm">
        <li><a href="#" className="hover:text-[#ff9d00] transition">Help Center</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">Privacy Policy</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">Terms of Service</a></li>
        <li><a href="#" className="hover:text-[#ff9d00] transition">FAQs</a></li>
      </ul>
    </div>
  </div>
